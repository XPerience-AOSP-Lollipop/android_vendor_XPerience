...
PRODUCT_VERSION_MAINTENANCE = 1_r37
...
ifeq ($(filter FINAL RELEASE NIGHTLY SNAPSHOT EXPERIMENTAL,$(CM_BUILDTYPE)),)
    CM_BUILDTYPE :=
endif
...
ifeq ($(CM_BUILDTYPE), FINAL)
CM_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)-$(shell date -u +%Y%m%d)-$(CM_BUILD)-FINAL
endif
